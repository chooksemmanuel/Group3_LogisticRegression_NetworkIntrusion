...
# \- Statistical Classification \& Decision Boundaries
...
# &nbsp;  git clone https://github.com/chooksemmanuel/Group3\_LogisticRegression\_NetworkIntrusion.git

# ```

# 2\. Open `LogisticRegressionClassifier\_Workshop\_Intrusion.ipynb` in VS Code or Google Colab
